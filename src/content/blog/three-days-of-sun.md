...
On June 9, Anthropic released Claude Fable 5 to the general public. Fable was the safety-gated version of its Mythos-class model: same underlying system, different perimeter. The highest-risk requests were quietly routed by classifiers into a more conservative lane, which meant the public was not getting Mythos itself, and it was not getting the first powerful model it had ever touched. Still, Fable crossed the line builders actually care about: capable enough, available enough, and ordinary enough that the machine stopped presenting as spectacle and started behaving like infrastructure. For roughly three days, the distance between imagining a thing and making the thing materially shrank.
...
The obvious story is the directive. Or the politics. Or the market reaction. Or the competitive question of what this does to the AI race. All of that matters, but it is not the center of gravity. The more useful story is what Fable exposed: the difference between people who were ready to use a more powerful system, and people who were only ready to rent one.

Plato gives us the cleaner frame. In the cave allegory, prisoners sit chained in place, watching shadows move across a wall, accepting those shadows as reality because nothing in their experience has forced them to need a better explanation. One prisoner is dragged outside into the sun. At first, the light hurts. Then it clarifies. The cruel part is not only the cave; it is the return. Once you have seen daylight, the shadows you were content with become harder to mistake for the whole world. You can go back to the wall, but you cannot honestly go back to believing the wall is reality.
