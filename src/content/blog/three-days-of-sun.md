...
On June 9, Anthropic released Claude Fable 5 to the general public. Fable was the safety-gated version of its Mythos-class model: the same underlying system, but kept inside a narrower perimeter. The highest-risk requests were caught by classifiers and routed into a more conservative lane, which meant the public was not getting Mythos itself, and we were not suddenly standing at the first edge of powerful AI. That was not the line that mattered. The line builders felt, before the commentary machine could digest the moment into the usual take-farm sludge, was more practical: capable enough to change the work, available enough to matter under deadline, and ordinary enough that it stopped behaving like a demo and started acting like infrastructure. For roughly three days, the distance between thinking the thing and making the thing got materially shorter.
