...
On June 9, Anthropic released Claude Fable 5 to the general public. Fable was the safety-gated version of its Mythos-class model: same underlying system, different perimeter. The highest-risk requests were quietly routed by classifiers into a more conservative lane, which meant the public was not getting Mythos itself, and it was not getting the first powerful model it had ever touched. Still, Fable crossed the threshold builders actually care about: capable enough, available enough, and ordinary enough that the machine stopped feeling like a spectacle and started behaving like infrastructure. For roughly three days, the distance between imagining a thing and making the thing materially shrank.
