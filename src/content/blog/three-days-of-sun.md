...
On June 9, Anthropic released Claude Fable 5 to the general public. Fable was the safety-gated version of its Mythos-class model: the same underlying system, but operating inside a narrower perimeter. The highest-risk requests were caught by classifiers and routed into a more conservative lane, which meant the public was not getting Mythos itself, and we were not standing at the edge of the first powerful model humanity had ever encountered. That was not the meaningful threshold. The threshold builders felt, before the commentary machine could metabolize the moment into its preferred little take-farm, was simpler: capable enough to change the work, available enough to matter under pressure, and ordinary enough that it stopped feeling like a demo and started behaving like infrastructure. For roughly three days, the distance between thinking the thing and making the thing got materially shorter.
