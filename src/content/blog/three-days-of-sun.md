...
On June 9, Anthropic released Claude Fable 5 to the general public. Fable was the safety-gated version of its Mythos-class model: the same underlying system, but inside a narrower operating perimeter. The highest-risk requests were caught by classifiers and pushed into a more conservative lane, which meant the public was not getting Mythos itself, and it was not touching the first powerful model humanity had ever encountered. That was never the real line. The real line was the one builders felt before the commentary machine had time to turn it into content slurry: capable enough to change the work, available enough to use under pressure, and ordinary enough that the machine stopped feeling like a demo and started acting like infrastructure. For roughly three days, the distance between thinking the thing and making the thing became materially shorter.
