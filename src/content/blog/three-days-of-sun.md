...
On June 9, Anthropic released Claude Fable 5 to the general public. Fable was the safety-gated version of its Mythos-class model: same underlying system, different perimeter. Classifiers quietly pushed the highest-risk requests into a more conservative lane, which meant the public was not getting Mythos itself, and it was not getting the first powerful model it had ever touched. Still, Fable crossed the threshold builders actually care about: capable enough, available enough, and normal enough that people could stop observing the machine as a spectacle and start building through it as infrastructure. For roughly three days, the distance between imagining the thing and making the thing became materially smaller.
