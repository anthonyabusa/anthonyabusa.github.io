...
On June 9, Anthropic released Claude Fable 5 to the general public. Fable was the safety-gated version of its Mythos-class model: the same underlying system, but working inside a narrower perimeter. The highest-risk requests were caught by classifiers and routed into a more conservative lane, which meant the public was not getting Mythos itself, and it was not standing at the edge of the first powerful model humanity had ever met. That was not the line that mattered. The line that mattered was the one builders felt before the commentary machine could metabolize it into takes: capable enough to change the work, available enough to use under pressure, and ordinary enough that the machine stopped feeling like a demo and started behaving like infrastructure. For roughly three days, the distance between thinking the thing and making the thing got materially shorter.
