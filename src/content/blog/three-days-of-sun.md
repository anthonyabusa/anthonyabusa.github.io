...
On June 9, Anthropic released Claude Fable 5 to the general public. Fable was the safety-gated version of its Mythos-class model: the same underlying system, wrapped in a different perimeter, with classifiers quietly routing the highest-risk requests into a more conservative lane. It was not the first powerful model the public had touched. It was not Mythos itself, which remained restricted. But it crossed the threshold builders actually care about: capable enough, available enough, and normal enough that people could stop standing around the machine admiring it and start building through it. For roughly three days, the distance between imagining a thing and making the thing got meaningfully shorter.
