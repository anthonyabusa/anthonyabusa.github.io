...
On June 9, Anthropic released Claude Fable 5 to the general public. Fable was the safety-gated version of its Mythos-class model: same underlying system, different perimeter, with classifiers quietly routing the highest-risk requests into a more conservative lane. It was not the first powerful model the public had touched. It was not Mythos itself, which remained restricted. But it was capable enough, available enough, and ordinary enough in its interface to matter. For roughly three days, builders felt the distance between imagining a thing and making it collapse into something meaningfully shorter.
