...
On June 9, Anthropic released Claude Fable 5 to the general public. Fable was the safety-gated version of its Mythos-class model: the same underlying system, but with a different perimeter around it. The highest-risk requests were quietly caught by classifiers and routed into a more conservative lane, which meant the public was not getting Mythos itself, and it was not getting the first powerful model humanity had ever touched. Still, Fable crossed the threshold builders actually care about: capable enough to change the work, available enough to be used in anger, and ordinary enough that the machine stopped feeling like a demonstration and started behaving like infrastructure. For roughly three days, the distance between imagining a thing and making the thing materially smaller.
