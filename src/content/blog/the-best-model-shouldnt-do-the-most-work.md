...
The first time you get access to a frontier model, the temptation is to hand it the whole workshop. It is the smartest thing in the room, or at least the most visibly capable one, so the “responsible” move can feel obvious: route everything through it, let raw intelligence eat the mess, and treat the bill as the cost of doing serious work. I ran my system that way for about a week. Every draft, every file rename, every three-line summary, every piece of procedural shrapnel went through the most capable and most expensive model I had. A week was enough for the premise to convict itself, first quietly, then all at once, because eventually the invoice stops being a receipt and starts acting like instrumentation.
