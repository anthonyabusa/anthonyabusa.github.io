...
Goals don't get you there; systems do. "Use the expensive model less" is a goal, and goals decay the moment you're busy. An architecture that makes the cheap path the default and routes to the expensive one only when judgment is genuinely required — that holds, because it doesn't depend on your discipline at 11pm. You built the discipline into the walls.
