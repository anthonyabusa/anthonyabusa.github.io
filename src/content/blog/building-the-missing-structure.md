...
I was handed “Student Body President,” but beneath the title there was not much of a machine: no operating rhythm, no durable process, no mechanism sturdy enough to survive the person sitting in the chair. The role carried responsibility, but almost none of the structure that made responsibility usable. Before I could do the job, I had to build the thing that made the job possible. At the time, I did not recognize this as a pattern. It was just the work in front of me.

Then the pattern developed the mildly inconvenient habit of following me.

A few years later, I was at a chemicals company older than the light bulb, and I founded its North American Government Affairs function from nothing: no team, no mandate, no precedent worth copying, only a gap that mattered and enough institutional room to build into it. More recently, the missing structure has been my own. I built an autonomous AI system to run the operations of how I work, because the tool I wanted did not exist yet, and waiting politely for someone else to ship it felt like confusing patience for strategy. Same move, different altitude.
