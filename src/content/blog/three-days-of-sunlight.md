...
That is the mood across much of the internet this week. The models people were genuinely happy with ten days ago — fast, capable, better than anything they'd had the year before — suddenly feel a little dim. Nothing about those models changed. They did not get worse. What changed is the reference point; the disappointment is the toll you pay for having glimpsed something better and been handed back the merely-good.
